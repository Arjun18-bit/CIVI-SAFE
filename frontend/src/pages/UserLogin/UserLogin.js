...
const UserLogin = () => {
  ...
  // Test credentials
  const testUsers = [
    { username: 'citizen', password: 'citizen123', role: 'user', description: 'Regular Citizen' },
    { username: 'student', password: 'student123', role: 'student', description: 'Student Account' }
  ];
          ...
          <div className="bg-gradient-to-br from-gray-50 via-white to-gray-100 border border-gray-200 rounded-xl p-5 text-sm text-gray-700 shadow-lg transition-all duration-300">
            ...
            {autofilledUser && (
              <div className="mt-2 text-xs text-green-600 flex items-center gap-1 animate-fade-in">
                ...
                Autofilled <span className="font-semibold">{autofilledUser}</span>!
              </div>
            )}
          </div>
        </div>
